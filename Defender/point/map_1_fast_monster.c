...
** my_defender
** File description:
** init point for map 1 for fast monster
*/

#include "include/defender.h"

void init_point_map1_fast_2(point *point_map, float speed)
{
...
point *init_point_map1_fast(int nb_points, float speed)
{
    ...
    point_map[6] = init_point(1450, 540, 0, speed * -1);
    point_map[7] = init_point(1530, 540, speed * -1, 0);
    ...
    init_point_map1_fast_2(point_map, speed);
    return (point_map);
}